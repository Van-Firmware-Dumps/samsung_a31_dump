...
cat system/system/app/SKTMemberShip_new/SKTMemberShip_new.apk.* 2>/dev/null >> system/system/app/SKTMemberShip_new/SKTMemberShip_new.apk
rm -f system/system/app/SKTMemberShip_new/SKTMemberShip_new.apk.* 2>/dev/null
